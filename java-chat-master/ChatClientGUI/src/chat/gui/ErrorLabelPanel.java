...
public class ErrorLabelPanel extends JPanel {
	private static final long serialVersionUID = 1L;

	public ErrorLabelPanel(String text) {
		setOpaque(true);
		...
		label.setSize(getWidth(), label.getPreferredSize().height);
		...
		p2.setBackground(new Color(55, 40, 40));
		p2.setOpaque(true);
		p2.setBounds(tlb.getBounds());
		add(p2);
		
		JPanel p1 = new JPanel();
		p1.setBackground(new Color(70, 50, 50));
		p1.setOpaque(true);
	...
	protected void paintComponent(Graphics g) {
		...
		g2.setColor(new Color(70, 40, 40));
